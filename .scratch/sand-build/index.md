...
| 03 | [Test runner and the two seams](issues/03-test-runner-and-the-two-seams.md) | 02 | done |
...
| 10 | [Spacing, Radius, Shadow, Motion pages](issues/10-spacing-radius-shadow-motion-pages.md) | 02, 21 | done |
| 11 | [Component page pattern and form controls](issues/11-component-page-pattern-and-form-controls.md) | 01, 21 | done |
| 12 | [Overlay and menu component pages](issues/12-overlay-and-menu-component-pages.md) | 11, 22 | done |
...
| 15 | [Conversation component pages](issues/15-conversation-component-pages.md) | 11 | done |
| 16 | [Mechanics pages settled](issues/16-mechanics-pages-settled.md) | 01, 21 | done |
| 17 | [Example project and 0.0.1](issues/17-example-project-and-001.md) | 05, 06, 07, 08, 09, 10, 11, 12, 13, 14, 15, 16 | done |
| 18 | [Installation guide, update script, consumer AGENTS.md](issues/18-installation-guide-update-script-consumer-agentsmd.md) | 17 | done |
| 19 | [Outside consumer test and 0.1.0](issues/19-outside-consumer-test-and-010.md) | 18 | blocked-on-human |
| 20 | [README with visuals and Overview refresh](issues/20-readme-with-visuals-and-overview-refresh.md) | 17, 21 | done |
