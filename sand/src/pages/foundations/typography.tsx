...
import { InlineCode, PageHeader, Rule, RuleList, Section } from "@/docs/page";
...
// TODO: the rules move to `rules/typography.md` in ticket 02; until then
// they live here as data.
  ...
  return (
    <>
      ...
      <Section id="rules" title="Rules">
        <RuleList>
          <Rule
            title="Use a role, not a size"
            body="One utility carries size, line height, weight, and tracking; the raw scale is for exceptions."
            do={{
          ...
          />
          <Rule
            title="Keep one heading-1 per page"
            body="The page title is heading-1; sections step down to heading-2."
            do={{
          ...
          />
          <Rule
            title="Do not shrink body text below body-sm for reading"
            body="Caption is for labels and hints, not for a paragraph."
            do={{
          ...
          />
          <Rule
            title="Use the code role for code, keys, and numbers that align"
            body="Mono with tabular figures keeps the columns straight."
            do={{
